...
func (e *V3Engine) RegistryLogin(_ context.Context, opts *helmengine.RegistryLoginOptions) error {
...
func (e *V3Engine) RegistryLogout(_ context.Context, opts *helmengine.RegistryLogoutOptions) error {
	client, err := registry.NewClient(
		registry.ClientOptWriter(io.Discard),
		registry.ClientOptCredentialsFile(os.Getenv("HELM_REGISTRY_CONFIG")),
	)
