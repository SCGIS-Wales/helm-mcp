...
func (e *V3Engine) RepoList(_ context.Context, _ *helmengine.RepoListOptions) ([]*helmengine.RepoEntry, error) {
	settings := cli.New()
...
func (e *V3Engine) RepoUpdate(_ context.Context, opts *helmengine.RepoUpdateOptions) (string, error) {
	settings := cli.New()
...
func (e *V3Engine) RepoRemove(_ context.Context, opts *helmengine.RepoRemoveOptions) error {
	settings := cli.New()
...
func (e *V3Engine) RepoIndex(_ context.Context, opts *helmengine.RepoIndexOptions) error {
